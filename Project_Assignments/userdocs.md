...
<img src="../files/ui_ingredients.jpg" width="400"/>
...
<img src="../files/ui_recipes.jpg" width="400"/>

### Adding Recipes 
If you want to add a new recipe, simply click the plus button located near the bottom right of the recipes screen to launch the recipe editor and get started. Within the recipe editor, you will first need to add all of the ingredients required for the recipe. There will be a small plus icon at the bottom right within the ingredients table that you can click to add a new ingredient. Enter information for the ingredient you wish add into the fields and hit the save button. Carry out that process for each ingredient you need to add to the recipe. When you are done adding ingredients, hit the "STEPS" tab to move on to adding steps for the recipe. Adding steps will be very similar to adding ingredients; simply click the plus button within the table to add a new step. A popup will appear and all you need to do is enter the step information into the popup and hit "OK" when finished. You can make as few or as many steps as you like; if you prefer a single step that has all the information about the recipe, go for it! After adding all the ingredients and adding all the steps, hit the save button in the top right of the menu bar to save the recipe. You should now see your newly added recipe in the recipes screen!

<img src="../files/ui_edit_recipe.jpg" width="400"/>
...
Once in the recipe editor, you will see a table of ingredients just like when adding ingredients to a recipe. You can edit each ingredients information such as amount or unit type, as well as delete ingredients entirely or even add new ones. You can click an ingredient or swipe right to edit it. You can swipe left to remove it from the recipe altogether. You can hit the plus button to add new ingredients as well. Hit the "STEPS" tab and you will now be able to edit the recipe's steps. This works exactly like editing ingredients, where you can edit steps, delete steps, or add new steps. You can also hit the change photo button to update the recipes photo. This will open your camera, where you can take a picture of your masterpiece. Once you are done editing everything, hit the save button to save all the changes.
